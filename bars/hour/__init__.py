        ...
        for ticker in self.tickers:
            ...
            for year in reversed(range(int(self.from_year), int(self.to_year) + 1)):
                ...
                for month in range(1, 13):
                    ...
                    aggs_url = f'https://api.polygon.io/v2/aggs/ticker/{ticker}/range/{self.multiplier}/hour/{from_}/{to_}?adjusted=true&sort=asc&limit={self.limit}&apiKey={self.api_key}'
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Get hour bars')
